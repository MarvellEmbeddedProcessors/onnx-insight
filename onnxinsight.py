...
def parse_cmdline_options():
    ...
    parser.add_argument("--all", action='store_true', help = "Print all available tables")
    parser.add_argument("--info", action='store_true', help = "Print model general info table")
        ...
        for node in dic_model:
            ...
            if node["type"] == "Conv" or node["type"] == "ConvTranspose" or node["type"] == "MaxPool" or node["type"] == "AveragePool":
                try:
                    ...
                    print("warning: node does not have attributes information set, kernel information set to zero")
                    node["kernel_h"] = 0
                    node["kernel_w"] = 0
                try:
                    ...
                    print("warning: node does not have attributes information set, stride information set to 1")
                    node["stride_h"] = 1
                    node["stride_w"] = 1
                try:
                    ...
                    print("warning: node does not have attributes information set, dilation information set to 1")
                    node["dilation_h"] = 1
                    node["dilation_w"] = 1
                try:
                    ...
                    print("warning: node does not have attributes information set, pads information set to zero")
                    for i in range(4):
                        node["pad_"+ str(i)] =  0
            if node["type"] == "Conv" or node["type"] == "ConvTranspose":
                try:
                    ...
                    print("warning: node does not have attributes information set, group information set to 1")
                    node["group"] = 1
            node.pop("inputs")
            if "attrs" in node:
                node.pop("attrs")
